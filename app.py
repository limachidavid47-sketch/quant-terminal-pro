...
def obtener_friccion_regional(league_name):
    ...
    if "LPL" in nombre or "LDL" in nombre: return -2.0, 3.5, -1.5 
    if "LCK" in nombre: return 3.0, -3.5, 1.5 
    if "LEC" in nombre or "LCS" in nombre: return 1.0, 1.0, 0.5 
    return 0.0, 0.0, 0.0
...
def get_h2h_direct_history(t1_name, t2_name, df):
    ...
    return h2h_df.sort_values(by='date', ascending=False).head(8) 
